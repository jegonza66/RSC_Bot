...
def run(adoption_files_path, enrollment_files_path, Credentials):
    ...
    Old_ad_file, New_ad_file, date = Adoptions.load_files(Credentials=Credentials, adoption_files_path=adoption_files_path)
    ...
    Old_en_file, New_en_file = Enrollment.load_files(Credentials=Credentials, enrollment_files_path=enrollment_files_path)
    # add new concantenated columns
